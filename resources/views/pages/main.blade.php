                ...
                <div class="card-body">
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-infos -->
                      <img class="direct-chat-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user1-128x128.jpg" alt="message user image">
                      <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      ...
                      <!-- /.direct-chat-infos -->
                      <img class="direct-chat-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user3-128x128.jpg" alt="message user image">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user1-128x128.jpg" alt="User Avatar">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user7-128x128.jpg" alt="User Avatar">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user3-128x128.jpg" alt="User Avatar">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user5-128x128.jpg" alt="User Avatar">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user6-128x128.jpg" alt="User Avatar">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo $base_url;?>/vendor/almasaeed2010/adminlte/dist/img/user8-128x128.jpg" alt="User Avatar">
        ...
        <div class="container-fluid">
          ...
          <div style="overflow-x: scroll; overflow-y:scroll; height:400px;  display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(4, 1fr); grid-gap: 10px;" class="row">
            @foreach ($contents['parking_spaces'] as $spaces)
              ...
              @else
                <div style="text-align:center;" class="icon">
                  <i style="color: rgb(30, 190, 30); font-size: 50px;" title="Disponível"  class="ion-android-expand"></i><br>
