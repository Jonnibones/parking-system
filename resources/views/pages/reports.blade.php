            ...
            <div class="container">
                ...
                <form target="_blank" method="post">
                    ...
                    <div class="d-flex justify-content-end">
                      <button name="btnsTable" style="display:none;" class="btn btn-info" formaction="#" type="submit">
                        <i class="ion-printer"></i> PDF
                      </button>
                      <button name="btnsTable" style="display:none;" class="btn btn-info ml-2" formaction="#" type="submit">
