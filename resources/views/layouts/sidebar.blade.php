...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Usuário logado: {{session('user')['name']}}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <span title="{{ $contents['numberSpacesBadge']['Liberated'].' vaga(s) liberada(s)' }}" class="badge badge-success center">{{ $contents['numberSpacesBadge']['Liberated'] }}</span>
              <span title="{{ $contents['numberSpacesBadge']['Reserved'].' vaga(s) reservada(s)' }}" class="badge badge-warning center">{{ $contents['numberSpacesBadge']['Reserved'] }}</span>
              <span title="{{ $contents['numberSpacesBadge']['Occupied']. ' vaga(s) ocupada(s)' }}" class="badge badge-danger center">{{ $contents['numberSpacesBadge']['Occupied'] }}</span>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
